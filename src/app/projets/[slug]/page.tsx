    ...
    <main className="flex-1 py-16 sm:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-16">
        ...
        <div className="space-y-8 pt-6 border-t border-white/[0.08]">
          {/* Challenge */}
          {project.challenge && (
            <div className="group relative rounded-3xl bg-[#0d0d10] border border-white/[0.08] hover:border-white/[0.18] hover:border-emerald-500/20 p-8 space-y-4 transition-all duration-300 overflow-hidden shadow-xl">
